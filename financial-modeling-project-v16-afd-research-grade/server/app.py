...
from server.handlers import (
    ...
    handle_chart,
    handle_fundamentals,
    handle_fundamental_trends,
    handle_similar_companies,
    handle_capm,
    handle_tickers,
    handle_fetch_post,
    handle_stop_post,
    ...
    handle_export_dcf,
    handle_portfolio,
    handle_portfolio_forecast,
    handle_portfolio_risk_contribution,
    handle_position_size_frontier,
    handle_portfolio_export,
    handle_event_study,
    handle_event_dates,
    handle_historical_validation,
    handle_historical_validation_forecast,
    handle_historical_validation_actual,
)
...
_GET_ROUTES: dict = {
    ...
    "/api/fundamental-trends": lambda qs: handle_fundamental_trends(qs),
    "/api/similar-companies": lambda qs: handle_similar_companies(qs),
    "/api/capm": lambda qs: handle_capm(qs),
    ...
    "/api/portfolio":    lambda qs: handle_portfolio(qs),
    "/api/portfolio/forecast": lambda qs: handle_portfolio_forecast(qs),
    "/api/portfolio/risk-contribution": lambda qs: handle_portfolio_risk_contribution(qs),
    "/api/portfolio/position-size-frontier": lambda qs: handle_position_size_frontier(qs),
    "/api/portfolio/export": lambda qs: handle_portfolio_export(qs),
    "/api/event-study": lambda qs: handle_event_study(qs),
    "/api/event-study/dates": lambda qs: handle_event_dates(qs),
    "/api/historical-validation": lambda qs: handle_historical_validation(qs),
    "/api/historical-validation/forecast": lambda qs: handle_historical_validation_forecast(qs),
    "/api/historical-validation/actual": lambda qs: handle_historical_validation_actual(qs),
}
