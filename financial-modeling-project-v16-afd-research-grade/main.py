...
from config.markets import STOCK_TICKERS, ETF_TICKERS, BOND_TICKERS
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Financial Research Engine — Portfolio · Validation · Event Study")
...
""")
    ...
    print(f"""
╔══════════════════════════════════════════════════════════╗
║   FINANCIAL RESEARCH ENGINE · Portfolio · Validation    ║
╠══════════════════════════════════════════════════════════╣
║  URL      →  http://localhost:{args.port:<28}║
║  Stocks   →  {len(STOCK_TICKERS):<43}║
║  ETFs     →  {len(ETF_TICKERS):<43}║
║  Bonds    →  {len(BOND_TICKERS):<43}║
